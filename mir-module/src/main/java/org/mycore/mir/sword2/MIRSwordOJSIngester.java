...
public class MIRSwordOJSIngester extends MIRSwordIngesterBase {
    ...
    private static HashMap<String, List<String>> extractDCFromMets(Document metsFileDocument) {
        final HashMap<String, List<String>> dcMetadata = new HashMap<>();
    ...
    private MCRContentTransformer getTransformer() {
